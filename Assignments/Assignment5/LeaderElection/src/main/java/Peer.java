...
public class Peer {
	...
	private static Set<Socket> setOfPeers = new HashSet<Socket>();
	 ...
	 * @param args[2] leader flag
	 */
	public static void main (String[] args) throws Exception {

		// Console buffer reader for general chatting. To pass into peer constructor later
